...
// node_modules/@clerk/shared/dist/runtime/error-inWE1T1f.mjs
...
function createBillingPaginatedHook({ hookName: hookName$4, resourceType, useFetcher, options }) {
  return function useBillingHook(params) {
    ...
    const billingEnabled = isForOrganization ? environment == null ? void 0 : environment.commerceSettings.billing.organization.enabled : environment == null ? void 0 : environment.commerceSettings.billing.user.enabled;
    ...
    return usePagesOrInfinite({
      ...
      config: {
        ...
        enabled: isEnabled,
        ...(options == null ? void 0 : options.unauthenticated) ? {} : { isSignedIn: Boolean(user) },
...
// node_modules/@clerk/shared/dist/runtime/versionSelector-BUe8Tert.mjs
var versionSelector = (clerkJSVersion, packageVersion = "5.109.0") => {
...
// node_modules/@clerk/shared/dist/runtime/loadClerkJsScript-DImt3duF.mjs
